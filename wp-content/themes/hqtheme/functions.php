...
class HQTheme {
    ...
    public function __construct() {
        //`lessc /home/katrazanov/www/hotelbudapest/wp-content/themes/hqtheme/less/hq-hotel/hq-hotel.less > /home/katrazanov/www/hotelbudapest/wp-content/themes/hqtheme/css/hq-hotel.css`;
		...
		require_once dirname(__FILE__) . '/inc/custom/weather.php'; // Hotel Weather
        ...
        include_once( get_template_directory() . '/inc/recent-posts-widget-with-thumbnails.php' );
...
function hqtheme_entry_social() {
    ...
    $share_header_title = get_theme_mod('hq_social_share_title');
    ...
    <?php if ($enable_facebook == 1 || $enable_twitter == 1 || $enable_google_plus == 1 || $enable_linkedin == 1 || $enable_pinterest == 1 || $enable_reddit == 1 || $enable_email == 1) : ?>
        <div class="entry-share man">
            <div class="share-options">
                <?php if ($share_header_title) echo '<p>' . $share_header_title . '</p>'; ?>
