...
class sidebar_generator {
        ...
        if (is_array($sidebars)) {
            foreach ($sidebars as $sidebar) {
                ...
                register_sidebar(array(
                    'name' => $sidebar,
                    'id' => 'custom-sidebar-' . strtolower($sidebar_class),
    ...
    public static function edit_form() {
        ...
        if (!is_array($selected_sidebar_replacement)) {
            ...
            $selected_sidebar_replacement['left'] = '-';
            $selected_sidebar_replacement['right'] = '-';
        }
        ?>
            ...
            <div id="sbg_box" class="postbox " >
                ...
                <div class="inside">
                    <div class="sbg_container">
                        ...
                        <p>Please select the sidebar you would like to display on this page. <strong>Note:</strong> You must first create the sidebar under Appearance > Sidebars.  <strong>Note:</strong> This option does not affect blog listing page.
                        </p>
                        <ul>
                            <?php
                            global $wp_registered_sidebars;
                            //var_dump($wp_registered_sidebars);
                            foreach (array('left' => 'Left Sidebar', 'right' => 'Right Sidebar') as $i => $name) {
                                ?>
                                <li>
                                    <?php echo $name; ?>
                                    <select name="sidebar_generator_replacement[<?php echo $i ?>]">
                                        ...
                                        ?>>Default</option><option value="0"<?php
...
function generated_dynamic_sidebar($name = '0', $width = 'col-sm-3') {
