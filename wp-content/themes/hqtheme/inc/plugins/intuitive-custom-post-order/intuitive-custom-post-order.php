...
define('HICPO_URL', get_template_directory_uri() . '/inc/plugins/intuitive-custom-post-order');
...
class Hicpo {
    ...
    function admin_menu() {
        add_options_page(__('Custom Post Order', 'hicpo'), __('Custom Post Order', 'hicpo'), 'manage_options', 'hicpo-settings', array(&$this, 'admin_page'));
    }
