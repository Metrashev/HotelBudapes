...
class HQ_Vote {
    ...
    public static function register() {
        wp_register_style('hq-vote', shortcodes_ultimate_url('assets/css/vote.css', SU_PLUGIN_FILE), false, SU_PLUGIN_VERSION, 'all');
        wp_register_script('hq-vote', shortcodes_ultimate_url('assets/js/vote.js', SU_PLUGIN_FILE), array('jquery'), SU_PLUGIN_VERSION, true);
    }
