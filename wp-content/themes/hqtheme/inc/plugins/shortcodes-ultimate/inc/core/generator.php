...
class HQ_Generator {
    ...
    public static function button($args = array()) {
        ...
        $args = wp_parse_args($args, array(
            ...
            'class' => 'button',
            'icon' => shortcodes_ultimate_url('assets/images/icon.png', SU_PLUGIN_FILE),
            'echo' => true,
            'shortcode' => false
        ));
        // Prepare icon
        ...
        // Cache not found
            ...
            <div id="hq-generator-wrap" style="display:none">
                <div id="hq-generator">
                    ...
                    <input type="hidden" name="hq-generator-selected" id="hq-generator-selected" value="<?php echo shortcodes_ultimate_url('', SU_PLUGIN_FILE); ?>" />
                    <input type="hidden" name="hq-generator-url" id="hq-generator-url" value="<?php echo shortcodes_ultimate_url('', SU_PLUGIN_FILE); ?>" />
    ...
    public static function settings() {
        ...
        // Cache not found
            ...
            $return .= apply_filters('su/generator/breadcrumbs', '<a href="javascript:void(0);" class="hq-generator-home" title="' . __('Click to return to the shortcodes list', 'su') . '">' . __('All shortcodes', 'su') . '</a> &rarr; <span>' . $shortcode['name'] . '</span> <small class="alignright">' . $shortcode['desc'] . '</small><div class="hq-generator-clear"></div>');
            $return .= '</div>';
