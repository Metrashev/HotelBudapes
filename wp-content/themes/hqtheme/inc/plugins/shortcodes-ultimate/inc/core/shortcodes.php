...
// Prepare vars
    ...
    public static function service($atts = null, $content = null) {
        $atts = shortcode_atts(array(
            ...
            'icon' => shortcodes_ultimate_url('assets/images/service.png', SU_PLUGIN_FILE),
            'icon_color' => '#333',
            'size' => 32,
            'class' => ''
                ), $atts, 'service');
...
// Prepare login link
    ...
    public static function dummy_text($atts = null, $content = null) {
        ...
        if ($return && $atts['cache'] === 'yes' && SU_ENABLE_CACHE)
            return $return;
        else {
