...
class HQ_Data {
    ...
    public static function groups() {
        ...
        return apply_filters('hq/data/groups', $groups);
    }
    ...
    public static function borders() {
        return apply_filters('hq/data/borders', array(
            'none' => __('None', 'su'),
            'solid' => __('Solid', 'su'),
            'dotted' => __('Dotted', 'su'),
            'dashed' => __('Dashed', 'su'),
        ...
        $shortcodes = array(
            ...
            'posts' => array(
                ...
                'atts' => array(
                    ...
                    'taxonomy' => array(
                        'type' => 'select',
                        'values' => HQ_Tools::get_taxonomies(),
                        'default' => 'category',
                        'name' => __('Taxonomy', 'su'),
                    ...
                    'tax_term' => array(
                        'type' => 'select',
                        'multiple' => true,
                        'values' => HQ_Tools::get_terms('category'),
                        'default' => '',
                        'name' => __('Terms', 'su'),
        ...
        $shortcodes['pricing_table'] = array(
            ...
            'atts' => array(
                'style' => array(
                    ...
                    'default' => '1',
                    'name' => __('Style', 'su'),
                    'desc' => __('Pricing Table Style', 'su')
                ),
            ...
            'content' => __('[pricing_plan name="Starter" price="Free" period="30-day trial" btn_url="http://example.com/" btn_text="Sign Up"]
<ul>
 <li>Feature 1</li>
 <li>Feature 2</li>
 <li>Feature 3</li>
...
[/pricing_plan]', 'su'),
            'desc' => __('Pricing Table', 'su'),
            'icon' => 'table');
        // Pricing Plan
        $shortcodes['pricing_plan'] = array(
            'name' => __('Pricing Plan', 'su'),
            'type' => 'wrap',
            'group' => 'content',
            'atts' => array(
                'name' => array(
                    'default' => '',
                    'name' => __('Name', 'su'),
                    'desc' => __('Plan Title', 'su')
                ),
                'featured' => array(
                    'type' => 'bool',
                    'default' => 'no',
                    'name' => __('Featured', 'su'),
                    'desc' => __('Featured Plan', 'su')
                ),
                'width' => array(
                    'type' => 'slider',
                    'min' => 0,
                ...
                'price' => array(
                    'default' => '$9.95',
                    'name' => __('Price', 'su'),
                    'desc' => __('Plan price', 'su')
                ),
                'period' => array(
                    'default' => '1 week',
                    'name' => __('Period', 'su'),
                    'desc' => __('Period price', 'su')
                ),
                'btn_text' => array(
                    'default' => 'Buy',
                ...
                'btn_url' => array(
                    'default' => '',
                    'name' => __('Button Url', 'su'),
                    'desc' => __('', 'su')
                ),
                'newtab' => array(
                    'type' => 'bool',
                    'default' => 'no',
                    'name' => __('Open in new tab', 'su'),
                    'desc' => __('', 'su')
                ),
            ),
            'content' => __('<ul>
 ...
 <li>Feature 3</li>
        ...
        // Paralax section
        $shortcodes['paralax_section'] = array(
            'name' => __('Paralax section', 'su'),
            'type' => 'wrap',
            'group' => 'content',
            'atts' => array(
                'effects_background' => array(
                    'type' => 'select',
                    'values' => array(
                        0 => __('No effect', 'su'),
                        1 => __('Effect 1', 'su'),
                    ...
                    'default' => 1,
                    'name' => __('Background effects', 'su'),
                    'desc' => __('', 'su')
                ),
                'effects_content' => array(
                    'type' => 'select',
                    'values' => array(
                        0 => __('No effect', 'su'),
                        1 => __('Effect 1', 'su'),
                ...
                'source' => array(
                    ...
                    'default' => '',
                    'name' => __('Source', 'su'),
                    'desc' => __('Choose images source. You can use images from Media library.', 'su')
                ),
                'color1' => array(
                    'type' => 'color',
                    'values' => array(),
                    'default' => '#ffffff',
                    'name' => __('Background Color 1', 'su'),
                    'desc' => __('', 'su')
                ),
                'color2' => array(
                    'type' => 'color',
        ...
        $shortcodes['person'] = array(
            ...
            'atts' => array(
                'picture' => array(
                    ...
                    'default' => '',
                    'name' => __('Picture', 'su'),
                    'desc' => __('Choose picture. You can use images from Media library.', 'su')
                ),
                'name' => array(
                    'default' => 'Name',
                    'name' => __('Name', 'su'),
        ...
        if (class_exists('Woocommerce')) {
            $shortcodes['recent_products'] = array(
                // Recent Products
                'name' => __('Recent Products', 'su'),
                'type' => 'single',
                'group' => 'shop',
                'atts' => array(
                    'per_page' => array(
                        'default' => 12,
                        'name' => __('Per Page', 'su'),
                        'desc' => __('The ‘per_page’ shortcode determines how many products to show on the page', 'su')
                    ),
                    'columns' => array(
                        'default' => 4,
                        'name' => __('Columns', 'su'),
                        'desc' => __('The columns attribute controls how many columns wide the products should be before wrapping.', 'su')
                    ),
                    'orderby' => array(
                        'default' => 'date',
                        'name' => __('Order by', 'su'),
                        'desc' => __('Order by field name', 'su')
                    ),
                    'order' => array(
                        'default' => 'desc',
                        'name' => __('Order direction', 'su'),
                        'desc' => ''
                    ),
                ),
                'desc' => __('Lists recent products.', 'su'),
                'note' => __('Lists recent products. The ‘per_page’ shortcode determines how many products to show on the page and the columns attribute controls how many columns wide the products should be before wrapping.', 'su'),
                'icon' => 'shopping-cart');
            // Featured Products
            $shortcodes['featured_products'] = array(
                'name' => __('Featured Products', 'su'),
                'type' => 'single',
                'group' => 'shop',
                'atts' => array(
                    'per_page' => array(
                ...
                'desc' => __('Lists featured products.', 'su'),
                'note' => __('Lists featured products. The ‘per_page’ shortcode determines how many products to show on the page and the columns attribute controls how many columns wide the products should be before wrapping.', 'su'),
                'icon' => 'shopping-cart');
            // Product
            $shortcodes['product'] = array(
                'name' => __('Product', 'su'),
                'type' => 'single',
                'group' => 'shop',
                'atts' => array(
                    'id' => array(
                        'default' => '',
                        'name' => __('Product Id', 'su'),
                    ),
                    'sku' => array(
                        'default' => '',
                        'name' => __('Product SKU', 'su'),
                    ),
                ),
                'desc' => __('Show a single product by ID or SKU.', 'su'),
                'icon' => 'shopping-cart');
            // Products
            $shortcodes['products'] = array(
                ...
                'atts' => array(
                    'id' => array(
                        'default' => '',
                        'name' => __('Products Ids', 'su'),
                    ),
                    'sku' => array(
                        'default' => '',
                        'name' => __('Products SKUs', 'su'),
                    ),
                    'columns' => array(
                        'default' => 4,
                        'name' => __('Columns', 'su'),
                ...
                'desc' => __('Show multiple products by ID or SKU.', 'su'),
                'icon' => 'shopping-cart');
            // Add to cart
            $shortcodes['add_to_cart'] = array(
                'name' => __('Add to cart', 'su'),
                'type' => 'single',
                'group' => 'shop',
                'atts' => array(
                    'id' => array(
                    ...
                    'style' => array(
                        'default' => '',
                        'name' => __('Style', 'su'),
                        'desc' => __('CSS Rules.', 'su')
                    ),
                ),
                'desc' => __('Show the price and add to cart button of a single product by ID.', 'su'),
                'icon' => 'shopping-cart');
            // Add to cart URL
            $shortcodes['add_to_cart_url'] = array(
                'name' => __('Add to cart URL', 'su'),
                'type' => 'single',
                'group' => 'shop',
                'atts' => array(
                    'id' => array(
                ...
                'desc' => __('Echo the URL on the add to cart button of a single product by ID.', 'su'),
                'icon' => 'shopping-cart');
            // Product page
            $shortcodes['product_page'] = array(
                'name' => __('Product page', 'su'),
                'type' => 'single',
                'group' => 'shop',
                'atts' => array(
                    'id' => array(
                ...
                'desc' => __('Show a full single product page by ID or SKU.', 'su'),
                'icon' => 'shopping-cart');
            // Product Category
            $shortcodes['product_category'] = array(
                'name' => __('Product Category', 'su'),
                'type' => 'single',
                'group' => 'shop',
                'atts' => array(
                    'per_page' => array(
                    ...
                    'category' => array(
                        'default' => '',
                        'name' => __('Category slug', 'su'),
                        'desc' => ''
                    ),
                ),
                'desc' => __('Show multiple products in a category by slug.', 'su'),
                'icon' => 'shopping-cart');
            // Product Categories
            $shortcodes['product_categories'] = array(
                'name' => __('Product Categories', 'su'),
                'type' => 'single',
                'group' => 'shop',
                'atts' => array(
                    'number' => array(
                        'default' => '',
                        'name' => __('Number', 'su'),
                        'desc' => __('The `number` field is used to display the number of products and the `ids` field is to tell the shortcode which categories to display.', 'su')
                    ),
                    'orderby' => array(
                        'default' => 'name',
                        'name' => __('Order by', 'su'),
                    ...
                    'hide_empty' => array(
                        'default' => 1,
                        'name' => __('Hide empty', 'su'),
                        'desc' => ''
                    ),
                    'parent' => array(
                        'default' => '',
                        'name' => __('Parent', 'su'),
                        'desc' => 'Set the parent paramater to 0 to only display top level categories.'
                    ),
                    'ids' => array(
                        'default' => '',
                        'name' => __('Ids', 'su'),
                        'desc' => 'Set ids to a comma separated list of category ids to only show those.'
                    ),
                ),
                'desc' => __('Display product categories loop', 'su'),
                'icon' => 'shopping-cart');
            // Sale Products
            $shortcodes['sale_products'] = array(
                'name' => __('Sale Products ', 'su'),
                'type' => 'single',
                'group' => 'shop',
                'atts' => array(
                    'per_page' => array(
                ...
                'desc' => __('List all products on sale.', 'su'),
                'icon' => 'shopping-cart');
            // Best Selling Products
            $shortcodes['best_selling_products'] = array(
                'name' => __('Best Selling Products', 'su'),
                'type' => 'single',
                'group' => 'shop',
                'atts' => array(
                    'per_page' => array(
                ...
                'desc' => __('List best selling products on sale.', 'su'),
                'icon' => 'shopping-cart');
            // Top Rated Products
            $shortcodes['top_rated_products'] = array(
                'name' => __('Top Rated Products', 'su'),
                'type' => 'single',
                'group' => 'shop',
                'atts' => array(
                    'per_page' => array(
                ...
                'desc' => __('List top rated products on sale.', 'su'),
                'icon' => 'shopping-cart');
            // Product Attribute
            $shortcodes['product_attribute'] = array(
                'name' => __('Product Attribute', 'su'),
                'type' => 'single',
                'group' => 'shop',
                'atts' => array(
                    'per_page' => array(
                ...
                'icon' => 'shopping-cart');
            // Related Products
            $shortcodes['related_products'] = array(
                'name' => __('Related Products', 'su'),
                'type' => 'single',
                'group' => 'shop',
                'atts' => array(
                    'per_page' => array(
                ...
                'desc' => __('List related products.', 'su'),
                'icon' => 'shopping-cart');
        }
        $shortcodes = apply_filters('hq/data/shortcodes', $shortcodes);
...
class Shortcodes_Ultimate_Data extends HQ_Data {
